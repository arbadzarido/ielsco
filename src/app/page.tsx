    ...
    <div className="bg-white min-h-screen font-sans selection:bg-[#E56668] selection:text-white overflow-x-hidden">
      ...
      <main className="flex flex-col w-full">
        ...
        <section className="relative px-6 sm:px-12 lg:px-[100px] flex flex-col lg:flex-row items-center justify-center w-full gap-8 lg:gap-16 pt-28 sm:pt-32 lg:pt-36 pb-20 lg:pb-28 bg-white overflow-hidden">
          ...
          <div className="order-2 lg:order-none flex flex-col justify-center items-center lg:items-start text-center lg:text-left w-full lg:w-1/2 space-y-6 z-10">
            <div className="text-[36px] sm:text-[48px] lg:text-[64px] text-[#1A2534] font-light leading-[1.1] tracking-tight animate-fadeIn">
              <p><span className="font-extrabold">Your Launchpad to</span></p>
              <p className="mt-2"><span className="font-extrabold text-[#E56668]">Global Opportunities.</span></p>
            </div>
        ...
        <section className="px-6 sm:px-12 lg:px-[100px] py-10 lg:py-12 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center space-y-4 mb-16">
              <span className="text-[#E56668] font-bold tracking-widest uppercase text-sm">Your Path Awaits</span>
                ...
                <div className="absolute bottom-12 left-0 w-[340px] bg-white rounded-[32px] p-6 shadow-2xl transform -rotate-3 hover:rotate-0 hover:scale-105 hover:z-40 transition-all duration-500 z-30 cursor-default border border-gray-100">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-14 h-14 bg-[#1A2534] rounded-full flex items-center justify-center overflow-hidden border-2 border-white shadow-sm relative">
                      <Image src="/images/contents/stories/member-stories/profile/dzakwan.png" alt="Ahmad Zakwaan" fill loading="lazy" className="object-cover" />
                    </div>
                    <div>
        ...
        <section className="px-6 sm:px-12 lg:px-[100px] py-12">
          <div className="max-w-7xl mx-auto">
            <div className="text-center space-y-4 mb-16">
              <span className="text-[#E56668] font-bold tracking-widest uppercase text-sm">Simple Process</span>
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#1A2534] tracking-tight">
                Four Steps to<br />
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
              ...
              {[
                { num: "1", bg: "bg-[#E56668]", title: "Set Your Goal", desc: "Define what you want: scholarship, remote job, or study abroad." },
                { num: "2", bg: "bg-[#1A2534]", title: "Learn & Practice", desc: "Join structured programs, daily practice, and expert mentorship." },
                { num: "3", bg: "bg-[#E56668]", title: "Track Progress", desc: "Get tested, receive feedback, and see exactly where you stand." },
                { num: "4", bg: "bg-[#1A2534]", title: "Achieve & Inspire", desc: "Reach your goal and inspire thousands with your success story." },
              ].map((step, i) => (
                <div key={i} className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 relative z-10">
                  <div className={`w-14 h-14 ${step.bg} rounded-2xl flex items-center justify-center mb-6 shadow-md`}>
                    <span className="text-2xl font-black text-white">{step.num}</span>
                  </div>
                  <h3 className="font-bold text-xl text-[#1A2534] mb-3">{step.title}</h3>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="bg-gradient-to-br from-[#1A2534] to-[#2F4157] rounded-[48px] p-10 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-12 overflow-hidden relative shadow-2xl">
              ...
              <div className="relative z-10 text-center lg:text-left max-w-2xl">
                <span className="text-[#E56668] font-bold tracking-widest uppercase text-sm mb-4 block">Daily Practice</span>
              ...
              <div className="relative z-10 flex-shrink-0 group">
                ...
                <Image
                  ...
                  style={{ filter: 'drop-shadow(0 0 2px #fff) drop-shadow(0 0 10px rgba(229, 102, 104, 0.5))' }}
                />
